...
namespace DatabaseFormApp {
    ...
    public partial class exampleDataSet : global::System.Data.DataSet {
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public Table1Row AddTable1Row(int Id, string FirstName, string LastName, int Age) {
...
namespace DatabaseFormApp.exampleDataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table1] WHERE (([Id] = @Original_Id) AND ([FirstName] = @Origi" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table1] ([Id], [FirstName], [LastName], [Age]) VALUES (@Id, @F" +
                "irstName, @LastName, @Age);\r\nSELECT Id, FirstName, LastName, Age FROM Table1 WHE" +
                "RE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table1] SET [Id] = @Id, [FirstName] = @FirstName, [LastName] = @LastName, [Age] = @Age WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Age] = @Original_Age));
SELECT Id, FirstName, LastName, Age FROM Table1 WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DatabaseFormApp.Properties.Settings.Default.exampleConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Age FROM dbo.Table1";
        ...
        public virtual int Fill(exampleDataSet.Table1DataTable dataTable) {
        ...
        public virtual exampleDataSet.Table1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            exampleDataSet.Table1DataTable dataTable = new exampleDataSet.Table1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(exampleDataSet.Table1DataTable dataTable) {
